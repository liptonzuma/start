...
function Navbar() {
    ...
    return (
    <>
    <nav className="md:hidden flex-col  bg-purple-700 flex justify-between p-5 text-lg">
      ...
      <nav className="nav-main items-center bg-purple-700 flex navbar justify-center p-5 text-lg">
        <a href="#" className="text-white logo text-3xl font-black">py<span className="text-green-400">.inc</span></a> 
