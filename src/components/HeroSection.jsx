...
function HeroSection() {
    return (
        ...
        <svg className="absolute top-5 z-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#DDD6FE" fillOpacity="1" d="M0,256L30,256C60,256,120,256,180,224C240,192,300,128,360,117.3C420,107,480,149,540,154.7C600,160,660,128,720,117.3C780,107,840,117,900,138.7C960,160,1020,192,1080,186.7C1140,181,1200,139,1260,112C1320,85,1380,75,1410,69.3L1440,64L1440,0L1410,0C1380,0,1320,0,1260,0C1200,0,1140,0,1080,0C1020,0,960,0,900,0C840,0,780,0,720,0C660,0,600,0,540,0C480,0,420,0,360,0C300,0,240,0,180,0C120,0,60,0,30,0L0,0Z"></path></svg>
        </motion.div>
        </>
    )
}
